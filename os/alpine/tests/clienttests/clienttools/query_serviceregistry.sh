...
jq ".serviceDefinitionRequirement = \"${CORE_SYSTEM_SERVICE_NAME}\" " sr_entry.request.template > "sr_${CORE_SYSTEM_SERVICE_NAME}_entry.request"
...
echo "orchestration-service provider details received ..."
